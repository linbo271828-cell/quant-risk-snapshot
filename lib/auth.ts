    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          // #region agent log
          fetch("http://127.0.0.1:7242/ingest/540f29d3-b53c-4854-a947-0acc20fc668e",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({runId:"credentials-authorize",hypothesisId:"H5",location:"lib/auth.ts:authorize:catch",message:"Credentials authorize threw error",data:{errorMessage:err instanceof Error ? err.message : "unknown"},timestamp:Date.now()})}).catch(()=>{});
          // #endregion
          return null;
        }
      },
